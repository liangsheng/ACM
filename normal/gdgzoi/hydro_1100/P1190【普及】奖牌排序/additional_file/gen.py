...
N = [1, 3, 3, 10, 20, 50, 500, 800, 900, 1000, 10000, 20000, 50000, 51000, 52000, 53000, 54000, 55000, 56000, 57000, 58000]
M = [1, 20, 20, 50, 50, 200, 200, 5000, 5000, 100000, 100000]
...
for t in range(1, T + 1):
    ...
    n = randint(max(N[t - 1], 3), N[t])
    g = [randint(0, n // 2) for i in range(n)]
    if t > 5:
        for i in range(max(n - 50, 0), n):
            g[i] = randint(100000000, 1000000000)

    s = [randint(0, n // 2) for i in range(n)]
    if t > 5:
        for i in range(max(n - 50, 0), n):
            s[i] = randint(100000000, 1000000000)

    b = [randint(0, n // 2) for i in range(n)]
    if t > 5:
        for i in range(max(n - 50, 0), n):
            b[i] = randint(100000000, 1000000000)

    if t in [5, 6, 7, 10, 11, 12]:
